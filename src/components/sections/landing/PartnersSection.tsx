...
export default function PartnersSection() {
    return (
        <section className="py-8 md:py-12 container mx-auto px-6 border-t border-white/5" id="partners">
            <div className="flex flex-col items-center justify-center gap-6 md:gap-8">
                ...
                <div className="opacity-70 hover:opacity-100 transition-opacity duration-300">
                    <div className="relative w-24 h-24 md:w-40 md:h-40 transition-all duration-500">
                        <Image
                            src="/unibo-logo.svg"
