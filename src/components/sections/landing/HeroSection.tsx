...
export default function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center text-center py-32 px-6 overflow-hidden">
      ...
      <h1 className="text-6xl md:text-8xl font-bold text-foreground mb-8 max-w-5xl bg-clip-text text-transparent bg-gradient-to-br from-primary via-purple-600 to-purple-400 tracking-tight leading-tight">
        The Community for <br className="hidden md:block" />
        <span className="text-primary">Ambitious Founders</span>
      </h1>
      <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl leading-relaxed">
        ...
        faster. Join the ecosystem built for growth.
      </p>
